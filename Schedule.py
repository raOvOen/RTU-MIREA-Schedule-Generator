...
if __name__ == "__main__":
    ...
    for i in range(0,work_week_amount):
        ...
        header_row.cells[0].text = "Дата занятия"
        header_row.cells[1].text = "Номер пары"
        header_row.cells[2].text = "Время проведения"
        header_row.cells[3].text = "Название дисциплины"
        header_row.cells[4].text = "Тип пары"
        header_row.cells[5].text = "Преподаватель"
        header_row.cells[6].text = "Место проведения"
